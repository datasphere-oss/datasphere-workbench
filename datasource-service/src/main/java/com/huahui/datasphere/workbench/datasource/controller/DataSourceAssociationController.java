...
import static com.huahui.datasphere.datasphere.workbench.common.security.SecurityConstants.AUTHORIZATION_HEADER_KEY;
impcom.huahui.datasphere com.huahui.datasphere.workbench.common.security.SecurityConstants.JWT_TOKEN_HEADER_KEY;

import java.io.IOException;
import java.lang.invoke.MethodHandles;
import java.util.List;

import javax.servlet.http.HttpSecom.huahui.dataspherest;
...
public class DataSourceAssociationController {
	...
	public ResponseEntity<?> associateDataSourcetoProject(HttpServletRequest request,
			@ApiParam(value = "DataSphere User login Id", required = true) @PathVariable("authenticatedUserId") String authenticatedUserId,
		...
		// The Model Service must call CDS to check if the DataSphere User Id is the owner of the project or not.
