...
import com.huahui.datasphere.datasphere.workbench.common.vo.DataSourcom.huahui.datasphere com.huahui.datasphere.workbench.common.vo.ServiceState;
...
public class DataSourceController {
	...
	public ResponseEntity<?> getDataSourcesList(HttpServletRequest request,
		...
		// Check the login user exists in DataSphere, or not by calling cds service
		dataSourceService.getUserDetails(authenticatedUserId);
